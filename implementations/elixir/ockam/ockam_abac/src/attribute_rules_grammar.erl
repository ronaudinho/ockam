-module(attribute_rules_grammar).
...
'rule'(Input, Index) ->
  p(Input, Index, 'rule', fun(I,D) -> (p_choose([fun 'filter_rule'/2, fun 'member_rule'/2, fun 'logical_rule'/2, fun 'boolean'/2]))(I,D) end, fun(Node, Idx) ->transform('rule', Node, Idx) end).
